export type TeeName = "diamond" | "black" | "blue" | "white" | "red";
...
// Real tees (black/blue/white/red) sourced from BlueGolf + herndongolf.com scorecard.
...
export const COURSE: CourseInfo = {
  ...
  teeInfo: {
    ...
    red:     { yards: 4935, rating: 68.9, slope: 116 },
  },
  holes: [
    // Front Nine
    {
      number: 1, par: 4, handicapIndex: 1,
      tees: { diamond: 510, black: 410, blue: 395, white: 375, red: 310 },
